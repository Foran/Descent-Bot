 ...
 ***************************************************/
#ifndef SRC_LIB_CONFIG_XML_H_
#define SRC_LIB_CONFIG_XML_H_
...
class CXMLNode {
 ...
 private:
  ///< Internal dictionary of Attributes
...
class CXML {
 public:
  ...
  explicit CXML(const ::std::string &filename);
